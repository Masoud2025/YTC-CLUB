...
const Hero: React.FC = () => {
  return (
    <section className="relative w-full overflow-hidden flex flex-col justify-center items-center">
      <div className="w-[80%] flex flex-col mt-[-3em]">
        <div className="grid grid-cols-1 items-center">
          ...
          <div className="relative w-full flex flex-col items-center justify-center">
            ...
            <button className="mt-0 relative sm:mt-4 px-6 sm:px-8 py-2 sm:py-3 text-indigo-600 dark:text-indigo-400 font-medium rounded-lg hover:cursor-pointer transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 mb-1 sm:mb-4">
              آشنایی با ما
            </button>
