  ...
  const socialMediaImages: SocialMediaImage[] = [
    {
      ...
      alt: 'YouTube Channel',
      href: 'https://www.youtube.com/channel/UC3ywjtM2cwU8-dT65PH0xpA/about',
    },
    {
      id: 2,
      src: '/youtubechanel1.png',
      alt: 'Youtube Account',
      href: 'https://www.youtube.com/@ALIXSHOT2/null',
    },
    {
      id: 3,
      src: '/youtubechanel2.png',
      alt: 'Youtube Account',
      href: 'https://www.youtube.com/@MEMENTOSTUDIOS',
    },
    {
      id: 4,
      src: '/youtubechanel3.png',
      alt: 'Youtube Account',
      href: 'https://www.youtube.com/@SeD_Ruski',
    },
    {
      id: 5,
      src: '/youtubechanel4.png',
      alt: 'Youtube Account',
      href: 'https://www.youtube.com/@erfantoxic410',
    },
    {
      id: 6,
      src: '/youtubechanel5.png',
      alt: 'Youtube Account',
      href: 'https://www.youtube.com/c/PixieFarnaz/playlists',
    },
    {
      id: 7,
      src: '/youtubechanel6.png',
      alt: 'Youtube Account',
      href: 'https://www.youtube.com/channel/UCRlmIBzSNqzBQHwJzcvB5qw/playlists?view=50&sort=dd&shelf_id=2',
    },
    {
      id: 8,
      src: '/youtubechanel7.png',
      alt: 'Youtube Account',
      href: 'https://www.youtube.com/channel/UC5I5P97GLaBri9bHt7ELn_g/about',
    },
    {
      id: 9,
      src: '/youtubechanel8.png',
      alt: 'Youtube Account',
      href: 'https://www.youtube.com/channel/UCr-VD-od50qA1aos_kIMMuw',
    },
    {
      id: 10,
      src: '/youtubechanel9.png',
      alt: 'Youtube Account',
      href: 'https://www.youtube.com/channel/UCyF07lOe-vfPLSPv5YhO8SA/videos?view=0&sort=p&shelf_id=0',
    },
  ];
